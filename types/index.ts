...
export interface Event {
  ...
  /** For virtual meetings (e.g. Zoom/Meet URL) */
  meetingLink?: string
  /** For physical meetings */
  address?: string
  /** Optional flier image/PDF URL (mock: data URL or placeholder) */
  flierUrl?: string
  /** 6-char alphanumeric; generated by manager, shared at meeting */
  checkInCode?: string
  /** ISO datetime when the check-in code stops working */
